...
! name, constant name
  ...
  {   'parent', 'child', 'children',
      'random', 'metaclass', 'sibling': parsed_number = w;
...
[ InfixExamineP brief x a b w flag lines;
  ...
  {   INFIXTT_NUMBER:
      ...
      INFIXTT_ROUTINE:
          if (brief) "; == ", noun;
          print "; Routine ", (InfixPrintRoutine) infix_parsed_lvalue,
              " (number ", infix_parsed_lvalue, ",
              packed address ", noun, ")^";
      INFIXTT_GLOBAL:
          if (brief) "; == ", noun;
          print "; Global ", (InfixPrintGlobal) infix_parsed_lvalue,
              " == ", noun, "^";
      INFIXTT_ARRAY:
          if (brief) "; == ", noun;
      ...
      INFIXTT_ACTION:
          if (brief) "; == ", noun;
          if (noun >= #lowest_fake_action_number
              && noun <= #highest_fake_action_number)
      ...
      INFIXTT_SYSFUN:
         ...
         "; System function ~", (address) infix_parsed_lvalue, "~ has
          not been overridden by any routine and so has its standard
          definition.";
