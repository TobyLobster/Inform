INFORM_APPDIR="/Users/tobynelson/Library/Developer/Xcode/DerivedData/Inform-abfymgdiyeabixberzezqkspixba/Build/Products/Development/Inform.app"

echo "************************************************************************************************"
echo "**** Check that the app has few symbols, and the dSYM has lots *********************************"
echo "************************************************************************************************"
echo Inform.app.dSym should have ~15349 lines:
wc -l <\/Users/tobynelson/Library/Developer/Xcode/DerivedData/Inform-abfymgdiyeabixberzezqkspixba/Build/Products/Development/Inform.app.dSYM/Contents/Resources/DWARF/Inform
echo "************************************************************************************************"
echo Inform.app should report ~299 symbols:
nm -a /Users/tobynelson/Library/Developer/Xcode/DerivedData/Inform-abfymgdiyeabixberzezqkspixba/Build/Products/Development/Inform.app/Contents/MacOS/Inform | wc -l
