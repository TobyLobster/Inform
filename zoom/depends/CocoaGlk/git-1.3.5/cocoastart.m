...
int main(int argv, const char** argc) {
	...
	char vString[64];
	sprintf(vString, "Git interpreter version %u.%u.%u", (unsigned int)((version>>16)&0xff), (unsigned int)((version>>8)&0xff), (unsigned int)(version&0xff));
	cocoaglk_log_ex(vString, 1);
	version = gestalt(GESTALT_SPEC_VERSION, 0);
	sprintf(vString, "Glulxe VM version %u.%u.%u", (unsigned int)((version>>16)&0xff), (unsigned int)((version>>8)&0xff), (unsigned int)(version&0xff));
	cocoaglk_log_ex(vString, 1);
